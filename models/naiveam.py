...
class NaiveAM(object):
    ...
    def train_NaiveAM(self, train_x, train_u, valid_x, valid_u):
    ...
    def load_model(self):
        self.net.load_state_dict(torch.load(f'./saved_models/NaiveAM_{self.param_name}.pt', map_location=self.device))
