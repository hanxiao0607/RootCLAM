...
def get_args():
    ...
    parser.add_argument('-s', '--seed', default=2, type=int, help='set random seed, default: random')
    ...
    parser.add_argument('--sample_seed', default=2, type=int, help='seed for sampling')
    ...
    parser.add_argument('--rc_quantile', default=0.100, type=float, help='Abnormal quantile for root cause (π)')
    parser.add_argument('--r_ratio', default=0.1, type=float, help='R ratio for flap samples (α)')
